...
iowa_23_24 <- read_csv(here::here("Data", "Iowa_Liquor_Sales_2023_2024.csv"))
iowa_22_23 <- read_csv(here::here("Data", "Iowa_Liquor_Sales_2022_2023.csv"))
iowa_21_22 <- read_csv(here::here("Data", "Iowa_Liquor_Sales_2021_2022.csv"))
iowa_20_21 <- read_csv(here::here("Data", "Iowa_Liquor_Sales_2020_2021.csv"))
iowa_pop <- read_excel(here::here("Data", "Iowa_City_Populations.xlsx"),
                       skip = 3)
```

```{r}
iowa_20_25 <- rbind(iowa_20_21, rbind(iowa_21_22, rbind(iowa_22_23, rbind(iowa_23_24, iowa_24_25))))

iowa_20_25 <- iowa_20_25 |>
...
df_iowa <- df_iowa |>
  ...
  inner_join(iowa_20_25, by = c("City", "PopYear")) |>
  filter(Sales > 0,
         LitersSold > 0) |>
